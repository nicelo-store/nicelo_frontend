        ...
        <div className="flex justify-center mb-10 mt-[-20px]">
          <div className="relative w-full max-w-md">
            <input
              ...
              className="w-full px-6 py-3 rounded-full bg-white/80 backdrop-blur-md border border-amber-200 text-stone-700 placeholder-stone-400 focus:outline-none focus:border-amber-300 focus:ring-2 focus:ring-amber-200/50 transition-all duration-300 shadow-sm font-['MB-vintage']"
            />
              ...
              >
                ...
                <div className="relative h-72 flex-shrink-0">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    ...
                    <p className="text-4xl font-bold bg-gradient-to-r from-amber-400 to-amber-300 bg-clip-text text-transparent font-['MB-vintage']">
                ...
                <div className="p-6 pt-4 bg-gradient-to-b from-white to-amber-50/30 overflow-y-auto flex-grow">
                  ...
                  {selectedProduct.description && (
                    <div className="mb-6">
                      <h4 className="text-lg font-semibold text-stone-800 mb-2 font-['MB-vintage']">Description</h4>
                      <p className="text-stone-600 leading-relaxed font-['MB-vintage']">
                        {selectedProduct.description}
                      </p>
                    </div>
                  )}
                  ...
                  <button
                    ...
                    className="w-full bg-green-500 hover:bg-green-600 text-white py-4 rounded-xl font-medium flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20 transform hover:-translate-y-0.5 font-['MB-vintage']"
                  >

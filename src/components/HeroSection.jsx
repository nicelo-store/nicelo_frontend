      ...
      <div className={`relative container mx-auto px-4 py-24 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
        <div className="max-w-4xl mx-auto text-center mt-10">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center mb-12">
            <button className="group relative bg-white hover:bg-white px-8 py-4 rounded-full shadow-lg hover:shadow-white/20 transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
              <span className="relative z-10 flex items-center justify-center gap-2 text-amber-800 font-medium">
                Shop Collection
            ...
            <button className="relative overflow-hidden group bg-transparent hover:bg-white/10 backdrop-blur-md text-white font-medium px-8 py-4 rounded-full transition-all duration-300 transform hover:-translate-y-1 border border-white/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-4">
          <div className="bg-white/5 backdrop-blur-md p-8 rounded-2xl shadow-lg border border-white/10 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-white/10 group">
            <div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
              <Star className="w-7 h-7 text-white" />
            </div>
            <h3 className="text-xl font-semibold text-white mb-3">Premium Quality</h3>
            <p className="text-white/70 leading-relaxed font-light">Handpicked dates and dairy products from the finest sources, guaranteed freshness with every order.</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md p-8 rounded-2xl shadow-lg border border-white/10 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-white/10 group">
            ...
            <p className="text-white/70 leading-relaxed font-light">Quick and reliable delivery to your location with real-time tracking and flexible delivery options.</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md p-8 rounded-2xl shadow-lg border border-white/10 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-white/10 group">
            ...
            <p className="text-white/70 leading-relaxed font-light">Safe and secure payment options for your peace of mind with encrypted transactions and buyer protection.</p>
          </div>
        </div>
      </div>
    </div>
